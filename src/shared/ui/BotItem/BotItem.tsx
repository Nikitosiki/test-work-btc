...
const BotItem: FC<BotItemProps> = ({
  ...
  return (
    <div
      ...
      <div className="bg-gradient-radial flex size-full flex-col items-center justify-end gap-1 rounded-lg from-custom-bg-light from-60% to-transparent sm:p-4 sm:pb-8 p-2 pb-4">
        <img
